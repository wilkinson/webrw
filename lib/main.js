...
//  use with multicore machines. It has been linted but not idiot-proofed ...
//
//                                                      ~~ (c) SRW, 06 Feb 2013
                ...
                req.on('end', function () {
                 // all chunks in
                    ...
                    implementation.set(AV.key, val, function (err) {
                     ...
                     // NOTE: Should the key be padded with quotation marks?
            ...
            http.createServer(function (request, response) {
             ...
             // which uses a middleware pattern to enable CORS.
                enable_cors(request, response, function () {
                 // The middleware pattern is annoying, isn't it?
